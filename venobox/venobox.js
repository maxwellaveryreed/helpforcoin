                  ...
                  obj.click(function(e){
                    ...
                    function checknav(){
                      ...
                      if(items.length > 1 && numeratio === true){
                        blocknum.html(items.innftpro(obj)+1 + ' / ' + items.length);
                        blocknum.show();
                      }else{
                        blocknum.hide();
                      }

                      thenext = items.eq( items.innftpro(obj) + 1 );
                      theprev = items.eq( items.innftpro(obj) - 1 );
                      ...
                      if (items.length > 1 && infinigall === true) {
                        ...
                        if(items.innftpro(obj) < 1 ){
                          theprev = items.eq( items.innftpro(items.length) );
                        }
